...
- (void) pocketsphinxRecognitionLoopDidStart {
    ...
    NSLog(@"Local callback: ro-de started."); // Log it.
    self.statusTextView.text = @"Status: ro-de started."; // Show it in the status box.
}

// An optional delegate method of OEEventsObserver which informs that Pocketsphinx is now listening for speech.
- (void) pocketsphinxDidStartListening {
    
    NSLog(@"Local callback: ro-de is now listening."); // Log it.
    self.statusTextView.text = @"Status: ro-de is now listening."; // Show it in the status box.
...
- (void) pocketsphinxDidDetectSpeech {
    NSLog(@"Local callback: ro-de has detected speech."); // Log it.
    self.statusTextView.text = @"Status: ro-de has detected speech."; // Show it in the status box.
}
...
- (void) pocketsphinxDidDetectFinishedSpeech {
    NSLog(@"Local callback: ro-de has detected a second of silence, concluding an utterance."); // Log it.
    self.statusTextView.text = @"Status: ro-de has detected finished speech."; // Show it in the status box.
}
...
- (void) pocketsphinxDidStopListening {
    NSLog(@"Local callback: robome has stopped listening."); // Log it.
    self.statusTextView.text = @"Status: ro-de has stopped listening."; // Show it in the status box.
}
...
- (void) pocketsphinxDidSuspendRecognition {
    NSLog(@"Local callback: ro-de has suspended recognition."); // Log it.
    self.statusTextView.text = @"Status: ro-de has suspended recognition."; // Show it in the status box.
}
...
- (void) pocketsphinxDidResumeRecognition {
    NSLog(@"Local callback: ro-de has resumed recognition."); // Log it.
    self.statusTextView.text = @"Status: ro-de has resumed recognition."; // Show it in the status box.
}
...
- (void) updateLevelsUI { // And here is how we obtain the levels.  This method includes the actual OpenEars methods and uses their results to update the UI of this view controller.
    ...
    self.pocketsphinxDbLabel.text = [NSString stringWithFormat:@"ro-de Input level:%f",[[OEPocketsphinxController sharedInstance] pocketsphinxInputLevel]];  //pocketsphinxInputLevel is an OpenEars method of the class OEPocketsphinxController.
